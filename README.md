...
- Make note of strange values in the dataset that can influence the evaluation of the analysis. Clarify how to deal with these strange values.
- Determine a course of action (or multiple) to categorize the products in the dataset & evaluate their effectiveness.
- Perform analyses using various parameters in the dataset.
- Provide ideas for further analysis.
